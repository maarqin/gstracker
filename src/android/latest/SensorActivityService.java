...
// import br.com.golsat.motionlocationpoc.MainActivity;
// import br.com.golsat.motionlocationpoc.R;
import com.gstracker.cordova.plugin.model.Position;
import com.gstracker.cordova.plugin.network.BasePositioningApi;
...
public class SensorActivityService extends Service {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "App name"/*getString(R.string.app_name)*/;
