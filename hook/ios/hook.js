function replaceAppDelegateM(acc, line) {
  return`
  //gstrack modified
  /*
...
function replaceAppDelegateH(acc, line) {
  return `
  //gstrack modified
  /*
  Licensed to the Apache Software Foundation (ASF) under one
...
function replaceMainCommandDelegateM(acc, line) {
  return `
  // gstrack modified
  /*
  Licensed to the Apache Software Foundation (ASF) under one
  ...
  */
  ...
  - (void) run:(NSDictionary *) dic {
      NSString* userId = [dic objectForKey:@"userId"];
      NSString* userEmail = [dic objectForKey:@"userEmail"];
      NSString* userDeviceId = [dic objectForKey:@"userDeviceId"];
      ...
      [[NSUserDefaults standardUserDefaults] setValue:userDeviceId forKey:USER_DEVICE_ID];
      [[NSUserDefaults standardUserDefaults] setValue:AVAILABLE forKey:IS_CONNECTION_OK];
  }

  - (void) exit {
      [[NSUserDefaults standardUserDefaults] setValue:NOTHING forKey:IS_CONNECTION_OK];
...
function replaceMainCommandDelegateH(acc, line) {
  return `
  // gstrack modified
  /*
  Licensed to the Apache Software Foundation (ASF) under one
